...
if(is_null($_SESSION['validated_user']) || $_SESSION['validated_user']) {
    ...
    <main>
        <section class="secciones" id="seccion-1">
            ...
            if (empty($m) && empty($t)) {
                ...
                include 'templates/article-random.php';
            } else {
                ...
                for ($i=0; $i < count($makeup); $i++) {
                    ...
                    (empty($t) && $makeup[$i]['brand'] === $m_fil) ) {
                        include 'templates/article-search.php';
                        $cont_resultados++; 
                    }
                }
                echo '</div>';
                if ($cont_resultados === 0) {
                    ...
                    <div class="sin-resultados">
                        ...
                        <a href="search.php" class="boton">back</a>
                    </div>
                    <?php
                }
            }
